...
const SingleBlog = ({ singleBlog }) => {
  ...
  return (
    <div className="py-5 ">
     ...
     <div className="relative card card-compact w-[390px] h-[440px] shadow-md  transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 bg-gray-200 duration-300  rounded-t-lg">
