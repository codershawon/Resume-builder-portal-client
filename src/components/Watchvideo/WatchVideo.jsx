...
const WatchVideo = () => {
  ...
  const handleSeeMoreClick = () => {
    setVisibleVideos(visibleVideos + 3); // Increase the number of visible videos by 3
  };
  ...
  return (
    <div>
      ...
      <FixedWidth>
        ...
        <div className="my-20 ps-4 md:ps-0 gap-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 flex-grow-0 mx-auto">
        ...
        <div className="my-20">
          ...
          <div className="mb-20  ps-16  md:ps-0 gap-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 flex-grow-0 mx-auto">
            <div>
              <div className="w-56 card h-96 rounded-2xl bg-base-100 shadow-xl">
