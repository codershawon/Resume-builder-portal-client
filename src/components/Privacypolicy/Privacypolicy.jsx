  ...
  return (
    <div>
      ...
      <div className="my-10 px-6 md:px-20 lg:px-36">
        <p>
          Welcome to our Resume Geneurs website ("us", "we", or "our"). We are
      ...
      <div className="my-10 px-6 md:px-20 lg:px-36">
        <div>
          <h4 className="text-3xl font-bold mb-8">1. Introduction</h4>
          <p>
            Welcome to our Resume Geneurs website ("us", "we", or "our"). We are
            committed to protecting your personal information and your right to
            privacy. This Privacy Policy explains how we collect, use, disclose,
        ...
        <div className="mb-10">
          ...
          <p>
            ...
            <br />
            <p className="mt-2">
              <span className=" font-bold">Resume Sharing:</span> You can choose
              to share your resume with potential employers or third parties. We
              are not responsible for the privacy practices of these parties.{" "}
            </p>
            <br />
            <p className="mt-2">
              <span className=" font-bold">Service Providers:</span> We may
              share your information with third-party service providers who help
              us operate, provide, and improve our services.
            </p>{" "}
            <br />
            <p className="mt-2">
              <span className=" font-bold mt-4">Legal Obligations:</span> We may
              disclose your information in response to legal requests, court
              orders, or legal processes.
            </p>
          </p>
        ...
        <div className="mb-10">
          ...
          <p>
            Registered users can review and change the Information at any time
            by accessing their accounts on the Site (through the My Account and
            My Settings tabs). You should promptly update your information if it
            changes or becomes inaccurate.
          </p>
        </div>
        <div className="mb-10">
          <h2 className="text-3xl font-bold mb-8"> 6. Your Choices</h2>
          <p>
            You can edit or delete your resume at any time through your account
            settings. You can opt out of receiving promotional emails from us by
            following the instructions provided in those emails. You may
            exercise your rights regarding your personal data in accordance with
            applicable laws.
          </p>
        </div>
        <div className="mb-10">
          <h2 className="text-3xl font-bold mb-8"> 7. Security</h2>
          <p>
        ...
        <div className="mb-10">
          <h2 className="text-3xl font-bold mb-8"> 8. Children's Privacy</h2>
          <p>
        ...
        <div className="mb-10">
          ...
          <p>
            We may update our Privacy Policy as our services evolve. We will
            notify you of any changes by posting the updated policy on our
            website.
          </p>
        </div>
        <div className="mb-10">
          <h2 className="text-3xl font-bold mb-5"> 10. Information Security</h2>
          <p>
        ...
        <div className="mb-10">
          ...
          <p>
            Remember to replace the bracketed placeholders with your specific
            details. Always ensure that your privacy policy is accurate,
            up-to-date, and compliant with relevant laws and regulations. It's
            recommended to seek legal counsel to ensure that your privacy policy
            adequately addresses the unique aspects of your resume genius
            website.
          </p>
        </div>
      </div>
