...
export function useAllTemplates(info, sectionDiv, styles, columns, summarySection, achievementSection, workExpSection, projectSection, educationSection, otherSection, containerRef, name, TiLocationArrow, AiOutlineMail, IoCallSharp, AiFillLinkedin, AiFillGithub, FaUserCircle, skillSection, languageSection) {
  const templates = [
    // Template 1
    (
      <div key="template1" className=''>
        <div ref={containerRef} className={styles.container}>
          <div>
            ...
            <div className=" my-10">
              <p className="border-b border-b-red-800 text-xl font-semibold mb-2">Skill Highlights</p>
              <p>{skillSection}</p>
            </div>
      ...
      <div key="template3" className=''>
        <div ref={containerRef} className={styles.container}>
          <div className="flex gap-3">
            <div className="bg-sky-900 text-white w-[35%] min-h-[1060px] ">
              <div className="ps-3">
            ...
            <div className="w-[75%]">
              ...
              <div className=" min-h-[120px] w-full mb-4 text-justify">
                <p className="uppercase border w-full ps-2 pt-1 pb-1 font-medium my-2 text-gray-700 text-[17px] ">Work EXPERIENCE</p>
                {workExpSection}
              </div>
              <div className=" min-h-[120px] w-full  text-justify">
                <p className="uppercase border w-full ps-2 pt-1 pb-1 font-medium  text-gray-700 text-[17px] ">Project</p>
                {projectSection}
              </div>
              <div className=" min-h-[120px] w-full  text-justify">
                <p className="uppercase border w-full ps-2 pt-1 pb-1 font-medium  text-gray-700 text-[17px] ">Education</p>
                {educationSection}
              </div>
            </div>
          </div>
      ...
      <div key="template4" className=''>
        <div ref={containerRef} className={styles.container}>
          <div>
            ...
            <div className=" min-h-[120px] w-full mb-4 text-justify">
              <p className="text-sky-900  text-[16px] uppercase font-bold mb-3">Experience</p>
              <p>{workExpSection}</p>
            </div>

            <div className=" min-h-[120px] w-full mb-4 text-justify">
              <p className="text-sky-900  text-[16px] uppercase font-bold mb-3">Education</p>
              <p>{educationSection}</p>
            </div>
            <div className=" min-h-[120px] w-full mb-4 text-justify">
              <p className="text-sky-900  text-[16px] uppercase font-bold mb-3">Achievement</p>
              <p>{achievementSection}</p>
            </div>
            <div className=" min-h-[120px] w-full mb-4 text-justify">
              <p className="text-sky-900  text-[16px] uppercase font-bold mb-3">Others</p>
              <p>{otherSection}</p>
            </div>
          </div>
        </div>
    ...
    (
      <div key="template7">
        <div ref={containerRef} className={styles.container}>
          <div>
            <div className={`flex gap-5 bg-[#c6a68dbb] relative ${styles.topStyle}`}>
